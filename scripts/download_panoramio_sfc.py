...
if __name__=="__main__":
    ...
    db_panoramio = open("../data/db_panoramio_sfc.txt", "w")
    ...
    for long in drange(50, 180, step_long):
        for lat in drange(-60, 90, step_lat):
            ...
            for start in drange(0, 140, 10):
                print(start)
                url = "http://www.panoramio.com/map/get_panoramas.php?set=full&from=%d&to=%d&minx=%f&miny=%f&maxx=%f&maxy=%f&size=medium&mapfilter=true"%(start, start+9, -122.519, 37.7229 , -122.362, 37.8060)
